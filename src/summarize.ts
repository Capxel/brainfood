...
async function openAiSummary(request: SummaryRequest, model: string): Promise<string> {
...
export async function generateSummary(request: SummaryRequest, enabled: boolean, model: string): Promise<string | null> {
